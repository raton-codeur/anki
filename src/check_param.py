...
def check_param() :
    ...
    myModels = define.MODEL_CARD, define.MODEL_REPLACE, define.MODEL_CLOZE, define.MODEL_TYPE, define.MODEL_TYPE_CLOZE
    myFieldss = define.MODEL_CARD_FIELDS, define.MODEL_REPLACE_FIELDS, define.MODEL_CLOZE_FIELDS, define.MODEL_TYPE_FIELDS, define.MODEL_TYPE_CLOZE_FIELDS
